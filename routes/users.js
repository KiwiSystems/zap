...
var Zap = require('../data/zap.js').Zap;
...
*/
router.put('/:id', restrict, function(req, res, next) {
...
*/
router.put('/:id/favorite', restrict, function(req, res, next) {
...
/*
    ...
    Response:
        ...
        - err: on failure, an error message
 */
router.delete('/:id', restrict, function(req, res, next) {
    User.remove({
        _id: req.params.id
    }, function(err, user) {
        if (err) return utils.sendErrResponse(res, 500, 'An unknown error occurred.');
...
/*
    ...
    If a user is not logged in, sends error
*/
